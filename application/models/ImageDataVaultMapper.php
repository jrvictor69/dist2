...
class Model_ImageDataVaultMapper {
    ...
    public function getDbTable() {
        if (null === $this->_dbTable) {
            $this->setDbTable('Model_DbTable_ImageDataVault');
        }
     ...
     * 
     * Saves model
     * @param Model_ImageDataVault $dataVault
     */
    public function save(Model_ImageDataVault $dataVault) {
    	$data = array(
     ...
     * @param Model_ImageDataVault $dataVault
     */
    public function update($id, Model_ImageDataVaultMapper $dataVault) {
     ...
     * @param int $id
     * @param int $isBinary
     * @return Model_ImageDataVaultMapper
     */
